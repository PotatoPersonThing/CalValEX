...
namespace CalValEX.Tiles.Blueprints
{
    public class DestroyerBlueprintPlaced : ModTile
    {
        ...
        {
            Item.NewItem(i * 16, j * 16, 48, 48, ItemType<DestroyerLog>());
        }
        ...
        {
            CalValEXGlobalTile.TileGlowmask(i, j, ModContent.GetTexture("CalValEX/Tiles/Blueprints/DestroyerBlueprintPlaced_Glow"), spriteBatch, animationFrameHeight, Type);
        }
    }
}
...
namespace CalValEX.Tiles.MiscFurniture
{
    internal class SePlaced : ModTile
    {
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            float x1 = 0;
            float x2 = rotationbottom / 5;
            float x3 = rotationbottom / 3.75f;
            float x4 = rotationbottom / 3;
            float x5 = rotationbottom / 2.5f;
            float x6 = rotationbottom / 2.14f;
            float x7 = rotationbottom / 1.875f;
            float xl = rotationbottom / 2.14f;
            float xr = rotationbottom / 2.14f;
            ...
            float y1 = 0;
            float y2 = rotationbottom / 10 * negavar;
            float y3 = rotationbottom / 5 * negavar;
            float y4 = rotationbottom / 3.75f * negavar;
            float y5 = rotationbottom / 3 * negavar;
            float y6 = rotationbottom / 2.5f * negavar;
            float y7 = rotationbottom / 2.14f * negavar;
            float yl = rotationbottom / 2.5f * negavar;
            float yr = rotationbottom / 2.5f * negavar;

...
namespace CalValEX.Tiles.Monoliths
{
    public class ExoMonolithPlaced : ModTile
    {
        ...
        {
            Item.NewItem(new Terraria.DataStructures.EntitySource_TileBreak(i, j), i * 16, j * 16, 32, 48, ModContent.ItemType<ExoMonolith>());
            CalValEXPlayer modPlayer = Main.LocalPlayer.GetModPlayer<CalValEXPlayer>();
            modPlayer.exoMonolith = false;
            providenceon = false;
        }

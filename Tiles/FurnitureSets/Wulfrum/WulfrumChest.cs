...
namespace CalValEX.Tiles.FurnitureSets.Wulfrum {
    public class WulfrumChest : ModTile {
        ...
        //Homies why is this commented
        /*public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            CalValEXGlobalTile.ChestGlowmask(i, j, ModContent.Request<Texture2D>("CalValEX/Tiles/FurnitureSets/Wulfrum/WulfrumChest_Glow").Value, spriteBatch);
        }*/

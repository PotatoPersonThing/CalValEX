...
namespace CalValEX.Tiles.FurnitureSets.Auric
{
    ...
    public class AuricDoorClosed : ModTile
    {
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            Texture2D glowmask = ModContent.GetTexture("CalValEX/Tiles/FurnitureSets/Auric/AuricDoorClosed_Glow");
        ...
        {
            Item.NewItem(i * 16, j * 16, 16, 48, ModContent.ItemType<AuricDoorItem>());
        }

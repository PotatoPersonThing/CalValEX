...
namespace CalValEX.Tiles.FurnitureSets.Auric
{
    ...
    public class AuricCandle : ModTile
    {
        ...
        {
            Item.NewItem(i * 16, j * 16, 16, 32, ModContent.ItemType<AuricCandleItem>());
        }
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            int xFrameOffset = Main.tile[i, j].frameX;
            int yFrameOffset = Main.tile[i, j].frameY;
            Texture2D glowmask = ModContent.GetTexture("CalValEX/Tiles/FurnitureSets/Auric/AuricCandle_Glow");

    ...
    public class OldAstralDresser : ModTile
	{
		...
		public override void MouseOverFar(int i, int j)
		{
			...
			else
			{
				...
				{
					player.cursorItemIconText = "Xenomonolith Dresser";
				}
				if (player.cursorItemIconText == "Xenomonolith Dresser")
				{
					player.cursorItemIconID = ModContent.ItemType<OldAstralDresserItem>();

            ...
            if (context == "bossBag")
            {
                    if (!CalValEXConfig.Instance.DisableVanityDrops)
                    {
                        ...
                        if (arg == ModContent.ItemType<SlimeGodBag>())
                        {
                            ...
                            {
                                player.QuickSpawnItem(player.GetSource_OpenItem(arg), ModContent.ItemType<SlimeGodMask>());
                            }
                        }
            ...
            if (!CalValEXConfig.Instance.DisableVanityDrops)
            {
                if (item.type == ModContent.ItemType<StarterBag>())
                {
                    if (player.whoAmI == Main.myPlayer)
                    {
                        ...
                        {
                            case "Jared":
                                player.QuickSpawnItem(player.GetSource_OpenItem(item.type), ModContent.ItemType<CanofWyrms>());
                            ...
                            case "Bojangles":
                            case "Bojeangles":
                                player.QuickSpawnItem(player.GetSource_OpenItem(item.type), ModContent.ItemType<AerialiteBubble>());
                                player.QuickSpawnItem(player.GetSource_OpenItem(item.type), ModContent.ItemType<ExtraFluffyFeatherClump>());
                                break;

                            case "William":
                                player.QuickSpawnItem(player.GetSource_OpenItem(item.type), ModContent.ItemType<RuinedBandage>());
                                break;
                            ...
                            case "Lil Sigtum":
                                ...
                                player.QuickSpawnItem(player.GetSource_OpenItem(item.type), ModContent.ItemType<SmolEldritchHoodie>());
                                break;

                            case "Hypera":
                                player.QuickSpawnItem(player.GetSource_OpenItem(item.type), ModContent.ItemType<SunBun>());
                                break;
                            ...
                            case "Fabsol":
                                player.QuickSpawnItem(player.GetSource_OpenItem(item.type), ModContent.ItemType<CosmicRapture>());
                                break;

                            case "Lucca":
                                player.QuickSpawnItem(player.GetSource_OpenItem(item.type), ModContent.ItemType<SuspiciousLookingChineseCrown>());
                                player.QuickSpawnItem(player.GetSource_OpenItem(item.type), ModContent.ItemType<ToyScythe>());
                                break;
                            ...
                            case "Tess":
                                player.QuickSpawnItem(player.GetSource_OpenItem(item.type), ModContent.ItemType<Geminga>());
                                break;

                            case "Enreden":
                                player.QuickSpawnItem(player.GetSource_OpenItem(item.type), ModContent.ItemType<CosmicBubble>());
                                break;
                            ...
                            case "Emerald":
                            case "EmeraldXLapis":
                                player.QuickSpawnItem(player.GetSource_OpenItem(item.type), ModContent.ItemType<PurifiedFog>());
                                break;

                            case "Yharex87":
                            case "Yharex":
                                player.QuickSpawnItem(player.GetSource_OpenItem(item.type), ModContent.ItemType<SpaceJunk>());
                                player.QuickSpawnItem(player.GetSource_OpenItem(item.type), ModContent.ItemType<AstraEGGeldon>());
                                break;
                            ...
                            case "DodoNation":
                            case "Dodo":
                                player.QuickSpawnItem(player.GetSource_OpenItem(item.type), ModContent.ItemType<ExtraFluffyFeather>());
                                break;

                            case "caligulasAquarium":
                            case "caligulas":
                                player.QuickSpawnItem(player.GetSource_OpenItem(item.type), ModContent.ItemType<BleuBlob>());
                                break;
                            ...
                            case "Potato Person":
                                player.QuickSpawnItem(player.GetSource_OpenItem(item.type), ModContent.ItemType<RottenKey>());
                                break;
                            ...
                            case "Triangle":
                                ...
                                player.QuickSpawnItem(player.GetSource_OpenItem(item.type), ModContent.ItemType<IonizedJellyCrystal>());
                                break;
                            ...
                            case "Brimmy":
                                ...
                                player.QuickSpawnItem(player.GetSource_OpenItem(item.type), ModContent.ItemType<RareBrimtulip>());
                                break;
                        }
                    }
                }
                ...
                if (item.type == ModContent.ItemType<CalamityMod.Items.Fishing.SulphurCatches.AbyssalCrate>())
                {
                    ...
                    if ((NPC.downedPlantBoss || CalamityMod.DownedBossSystem.downedCalamitas) & (Main.rand.NextFloat() < 0.04f))
                    {
                        player.QuickSpawnItem(player.GetSource_OpenItem(item.type), ModContent.ItemType<InkyPollution>());
                    }

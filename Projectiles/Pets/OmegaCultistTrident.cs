...
{
    public class OmegaCultistTrident : ModWalkingPet
    {
        ...
        {
            Gore.NewGore(Projectile.GetSource_FromAI(), Projectile.Center, new Vector2(0, -8), Mod.Find<ModGore>("OmegaTrident").Type, 1f);
        }
    }
}
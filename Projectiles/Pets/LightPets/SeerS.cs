...
namespace CalValEX.Projectiles.Pets.LightPets
{
    public class SeerS : FlyingPet
    {
        ...
        public override void SetUpFlyingPet()
        {
            ...
            speed = Owner.GetModPlayer<CalValEXPlayer>().Harbinger ? 27f :
                    Owner.GetModPlayer<CalValEXPlayer>().ScratchedGong ? 27f : 25f;
            inertia = 60f;
        ...
        {
            glowmaskTexture = CalValEX.month == 12 ? "ExtraTextures/ChristmasPets/SeerSGlow" : "Projectiles/Pets/LightPets/SeerS_Glow";
        }

...
namespace CalValEX.Projectiles.Pets.LightPets
{
    public class HeatPet : FlyingPet
    {
        ...
        {
     	    glowmaskTexture = "CalValEX/Projectiles/Pets/LightPets/HeatPet_Glow";
            //glowmaskTexture = CalValEX.month == 12 "CalValEX/ExtraTextures/ChristmasPets/HeatPetGlow" ? : "CalValEX/Projectiles/Pets/LightPets/HeatPet_Glow";
        }

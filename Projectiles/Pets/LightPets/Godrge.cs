...
namespace CalValEX.Projectiles.Pets.LightPets
{
    public class Godrge : FlyingPet
    {
        ...
        {
            auraTexture = "CalValEX/Projectiles/Pets/LightPets/GodrgeAura"; //aura texture location
            ...
            auraGlowmaskTexture = "CalValEX/Projectiles/Pets/LightPets/GodrgeAuraGlow"; //aura glowmask texture location
        }
        ...
        public override void SetUpLight() //for when the pet emmits light
        {
            ...
            intensity = 2f; //how intense the light should be. do not go over 2f or else the light will be too strong

...
{
    public class HeatBaby : FlyingPet
    {
        ...
        {
		glowmaskTexture = CalValEX.month == 12 ? "CalValEX/ExtraTextures/ChristmasPets/HeatBabyGlow" : "CalValEX/Projectiles/Pets/LightPets/HeatBaby_Glow";
        }
        ...
        public override void SetUpFlyingPet()
        {
            ...
            offSetX = -35f * -Main.player[Projectile.owner].direction; //this is needed so it's always behind the player.
            offSetY = -41f; //how much higher from the center the pet should float
        }

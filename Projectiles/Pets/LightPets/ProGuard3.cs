...
{
    public class ProGuard3 : FlyingPet
    {
        ...
        public override void SetUpFlyingPet()
        {
            ...
            offSetX = 78f * -Main.player[projectile.owner].direction; //this is needed so it's always behind the player.
            offSetY = -120f; //how much higher from the center the pet should float
        }

...
namespace CalValEX.Projectiles.Pets.LightPets
{
    public class SeerM : FlyingPet
    {
        ...
        {
            glowmaskTexture = CalValEX.month == 12 ? "CalValEX/ExtraTextures/ChristmasPets/SeerMGlow" : "CalValEX/Projectiles/Pets/LightPets/SeerM_Glow";
        }
        ...
        public override void SetUpLight() //for when the pet emmits light
        {
            ...
            intensity = 0.75f; //how intense the light should be. do not go over 2f or else the light will be too strong

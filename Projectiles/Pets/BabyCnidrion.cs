...
{
    public class BabyCnidrion : WalkingPet
    {
        ...
        {
            speed[0] = Owner.GetModPlayer<CalValEXPlayer>().NurseryBell ? 14f : 10f; //walking speed
            speed[1] = Owner.GetModPlayer<CalValEXPlayer>().NurseryBell ? 16f : 12f; //flying speed

    ...
    public class DeusTail : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (byUUID >= 0 && Main.projectile[byUUID].active &&
                (Main.projectile[byUUID].type == ModContent.ProjectileType<DeusBody>()) ||
                 Main.projectile[byUUID].type == ModContent.ProjectileType<DeusHead>())
            {
                ...
                if (Main.projectile[byUUID].type == ModContent.ProjectileType<DeusHead>() &&
                    projectile.type == ModContent.ProjectileType<DeusTail>())
                {

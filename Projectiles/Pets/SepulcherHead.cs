...
{
    public class SepulcherHead : ModProjectile
    {
        ...
        public override void AI()
        {
            if (!SpawnedSegments)
            {
                int tail = Projectile.NewProjectile(projectile.Center, Vector2.Zero, ModContent.ProjectileType<SepulcherTail>(),
                ...
                for (int i = 0; i < SegmentCount - 2; i++)
                {
                    ...
                    int body = Projectile.NewProjectile(projectile.Center, Vector2.Zero,
                        ModContent.ProjectileType<SepulcherBody>(), projectile.damage, projectile.knockBack,
                        0, uuid);

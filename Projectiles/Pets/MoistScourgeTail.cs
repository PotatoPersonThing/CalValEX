...
{
    public class MoistScourgeTail : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (byUUID >= 0 && Main.projectile[byUUID].active &&
                (Main.projectile[byUUID].type == ModContent.ProjectileType<MoistScourgeBody>()) ||
                 Main.projectile[byUUID].type == ModContent.ProjectileType<MoistScourgeHead>())
            {
                ...
                if (Main.projectile[byUUID].type == ModContent.ProjectileType<MoistScourgeHead>() &&
                    Projectile.type == ModContent.ProjectileType<MoistScourgeTail>())
                {

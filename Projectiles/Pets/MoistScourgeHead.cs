...
{
    public class MoistScourgeHead : ModProjectile
    {
        ...
        public override void AI()
        {
            if (!SpawnedSegments)
            {
                int tail = Projectile.NewProjectile(Projectile.GetProjectileSource_FromThis(), Projectile.Center, Vector2.Zero, ModContent.ProjectileType<MoistScourgeTail>(),

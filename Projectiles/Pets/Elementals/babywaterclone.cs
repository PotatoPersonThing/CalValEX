...
{
    public class babywaterclone : FlyingPet
    {
        ...
        {
            glowmaskTexture = "CalValEX/Projectiles/Pets/Elementals/babywaterclone_Glow";
        }
        ...
        public override void SetUpFlyingPet()
        {
            ...
            offSetX = 1f * -Main.player[Projectile.owner].direction; //this is needed so it's always behind the player.
            offSetY = -100f; //how much higher from the center the pet should float
        }

...
{
    public class DeusBody : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (segmentAhead >= 0 && Main.projectile[segmentAhead].active &&
                (Main.projectile[segmentAhead].type == ModContent.ProjectileType<DeusBody>()) ||
                 Main.projectile[segmentAhead].type == ModContent.ProjectileType<DeusHead>())
            {

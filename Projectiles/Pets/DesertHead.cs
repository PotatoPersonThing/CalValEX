...
namespace CalValEX.Projectiles.Pets
{
    public class DesertHead : ModProjectile
    {
        ...
        public override void AI()
        {
            if (!SpawnedSegments)
            {
                int tail = Projectile.NewProjectile(projectile.Center, Vector2.Zero, ModContent.ProjectileType<DesertTail>(),
                ...
                for (int i = 0; i < SegmentCount - 2; i++)
                {
                    ...
                    int body = Projectile.NewProjectile(projectile.Center, Vector2.Zero,
                        ModContent.ProjectileType<DesertBody>(), projectile.damage, projectile.knockBack,
                        0, uuid);

...
namespace CalValEX.Projectiles.Pets
{
    ...
    {
        public override string Texture => "CalamityMod/NPCs/DevourerofGods/DevourerofGodsBodyS";
        ...
        {
            Texture2D texture = ModContent.GetTexture("CalValEX/Projectiles/Pets/DogBody_Glow");

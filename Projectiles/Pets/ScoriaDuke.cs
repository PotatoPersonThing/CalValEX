...
{
    public class ScoriaDuke : FlyingPet
    {
        ...
        public override void SetUpFlyingPet()
        {
            ...
            speed = Owner.GetModPlayer<CalValEXPlayer>().Vaseline ? 16f : 12f;
            inertia = 60f;
            ...
            offSetX = 56f * -Main.player[projectile.owner].direction; //this is needed so it's always behind the player.

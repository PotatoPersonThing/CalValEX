...
{
    public class MechaGeorge : WalkingPet
    {
        ...
        public override void SetFrameLimitsAndFrameSpeed()
        {
            ...
            flyingFrameLimits[1] = 10; //what your min flying frame is (start of flying animation)
	    ...
	    {
		glowMask = ModContent.Request<Texture2D>("CalValEX/Projectiles/Pets/MechaGeorge_Glow").Value;
 	    }

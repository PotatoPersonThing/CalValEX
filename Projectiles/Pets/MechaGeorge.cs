...
namespace CalValEX.Projectiles.Pets
{
    public class MechaGeorge : ModWalkingPet
    {
        ...
        {
            Texture2D glowMask = ModContent.Request<Texture2D>("Projectiles/Pets/MechaGeorge_Glow").Value;
            if (CalValEX.month == 12)
            {
                glowMask = ModContent.Request<Texture2D>("ExtraTextures/ChristmasPets/MechaGeorgeGlow").Value;
            }

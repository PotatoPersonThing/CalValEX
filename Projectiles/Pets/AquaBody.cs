...
{
    public class AquaBody : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (segmentAhead >= 0 && Main.projectile[segmentAhead].active &&
                (Main.projectile[segmentAhead].type == ModContent.ProjectileType<AquaBody>()) ||
                 Main.projectile[segmentAhead].type == ModContent.ProjectileType<AquaHead>())
            {

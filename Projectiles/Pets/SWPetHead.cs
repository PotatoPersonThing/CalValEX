...
namespace CalValEX.Projectiles.Pets
{
    public class SWPetHead : ModProjectile
    {
        ...
        public override void AI()
        {
            if (!SpawnedSegments)
            {
                int tail = Projectile.NewProjectile(projectile.Center, Vector2.Zero, ModContent.ProjectileType<SWPetTail>(),
                ...
                for (int i = 0; i < SegmentCount - 2; i++)
                {
                    ...
                    int body = Projectile.NewProjectile(projectile.Center, Vector2.Zero,
                        ModContent.ProjectileType<SWPetBody>(), projectile.damage, projectile.knockBack,
                        0, uuid);

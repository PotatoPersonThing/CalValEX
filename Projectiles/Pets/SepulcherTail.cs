...
{
    public class SepulcherTail : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (byUUID >= 0 && Main.projectile[byUUID].active &&
                (Main.projectile[byUUID].type == ModContent.ProjectileType<SepulcherBody>()) ||
                 Main.projectile[byUUID].type == ModContent.ProjectileType<SepulcherHead>())
            {
                ...
                if (Main.projectile[byUUID].type == ModContent.ProjectileType<AquaHead>() &&
                    projectile.type == ModContent.ProjectileType<SepulcherTail>())
                {

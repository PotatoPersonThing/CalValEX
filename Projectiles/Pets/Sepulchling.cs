...
namespace CalValEX.Projectiles.Pets
{
    public class Sepulchling : BaseWormPet
    {
        ...
        public override WormPetVisualSegment HeadSegment() => new("CalValEX/Projectiles/Pets/SepulcherHead");
        public override WormPetVisualSegment BodySegment() => new("CalValEX/Projectiles/Pets/SepulcherBody");
        public override WormPetVisualSegment TailSegment() => new("CalValEX/Projectiles/Pets/SepulcherTail");

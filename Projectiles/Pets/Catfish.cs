...
{
    public class Catfish : WalkingPet
    {
        ...
        {
            speed[0] = Owner.GetModPlayer<CalValEXPlayer>().DustChime ? 12f : 10f; //walking speed
            speed[1] = Owner.GetModPlayer<CalValEXPlayer>().DustChime ? 14f : 12f; //flying speed

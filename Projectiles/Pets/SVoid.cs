...
namespace CalValEX.Projectiles.Pets
{
    public class SVoid : FlyingPet
    {
        ...
        public override void SetUpFlyingPet()
        {
            ...
            offSetX = 88f * -Main.player[projectile.owner].direction; //this is needed so it's always behind the player.
            offSetY = -20f; //how much higher from the center the pet should float
        }
        public override void SetUpAuraAndGlowmask()
        {
            glowmaskTexture = CalValEX.month == 12 ? "ExtraTextures/ChristmasPets/VoidOrbGlow" : "Projectiles/Pets/VoidOrb_Glow";
        }

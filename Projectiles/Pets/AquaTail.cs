    ...
    public class AquaTail : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (byUUID >= 0 && Main.projectile[byUUID].active &&
                (Main.projectile[byUUID].type == ModContent.ProjectileType<AquaBody>()) ||
                 Main.projectile[byUUID].type == ModContent.ProjectileType<AquaHead>())
            {
                ...
                if (Main.projectile[byUUID].type == ModContent.ProjectileType<AquaHead>() &&
                    projectile.type == ModContent.ProjectileType<AquaTail>())
                {

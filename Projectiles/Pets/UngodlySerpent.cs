...
{
    public class UngodlySerpent : WalkingPet
    {
        ...
        {
            speed[0] = Owner.GetModPlayer<CalValEXPlayer>().TubRune ? 8f : 10f; //walking speed
            speed[1] = Owner.GetModPlayer<CalValEXPlayer>().TubRune ? 10f : 12f; //flying speed

...
namespace CalValEX.Projectiles.Pets
{
    public class MiniCryo : ModFlyingPet
    {
        ...
        public override void CustomBehaviour(Player player, ref int state, float flyingSpeed, float flyingInertia)
        {
            ...
            {
                /*Dust mist = new MediumMistParticle(placementrun, Vector2.Zero, new Color(172, 238, 255), new Color(145, 170, 188), Main.rand.NextFloat(0.15f, 0.45f), 245 - Main.rand.Next(50), 0.02f);

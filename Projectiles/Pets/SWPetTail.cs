    ...
    public class SWPetTail : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (byUUID >= 0 && Main.projectile[byUUID].active &&
                (Main.projectile[byUUID].type == ModContent.ProjectileType<SWPetBody>()) ||
                 Main.projectile[byUUID].type == ModContent.ProjectileType<SWPetHead>())
            {
                ...
                if (Main.projectile[byUUID].type == ModContent.ProjectileType<SWPetHead>() &&
                    projectile.type == ModContent.ProjectileType<SWPetTail>())
                {

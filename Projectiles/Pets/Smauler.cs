...
{
    public class Smauler : FlyingPet
    {
        ...
        public override void SetUpFlyingPet()
        {
            ...
            speed = Owner.GetModPlayer<CalValEXPlayer>().Vaseline ? 14f : 12f;
            inertia = 60f;
            ...
            offSetX = modPlayer.shart ? (48f) : (48f * -Main.player[projectile.owner].direction); //this is needed so it's always behind the player.

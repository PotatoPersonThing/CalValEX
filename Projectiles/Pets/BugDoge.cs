...
{
    public class BugDoge : WalkingPet
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Buggo Doge");
        ...
        public override void SetFrameLimitsAndFrameSpeed()
        {
            ...
            flyingFrameLimits[1] = 4; //what your max flying frame is (end of flying animation)

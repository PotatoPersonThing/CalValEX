...
namespace CalValEX.Projectiles.Pets
{
	...
	public abstract class BaseWormPet : ModProjectile
	{
		...
		/// <summary>
		/// Enables light stuff, shouldLightUp enables light, RGB has rgb values divided by 255, intensity is the light's saturation, abyssLightLevel is the light value, check wiki
		/// </summary>

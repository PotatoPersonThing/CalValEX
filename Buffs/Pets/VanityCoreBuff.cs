...
namespace CalValEX.Buffs.Pets 
{
	...
	{		
		...
		public override void Update(Player player, ref int buffIndex) 
        {
			...
			bool petProjectileNotSpawned3 = player.ownedProjectileCounts[ModContent.ProjectileType<Projectiles.Pets.Skeetyeet>()] <= 0;
			...
			bool petProjectileNotSpawned4 = player.ownedProjectileCounts[ModContent.ProjectileType<Projectiles.Pets.Lightshield>()] <= 0;

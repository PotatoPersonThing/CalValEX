...
float4 BAstralPinkEffect(float4 sampleColor : COLOR0, float2 coords : TEXCOORD0) : COLOR0
{
...
{
    pass BlightedAstralPinkDyePass
    {
        PixelShader = compile ps_2_0 BAstralPinkEffect();
    }
}
...
namespace CalValEX.NPCs.Critters
{
    ...
    internal class NukeFly : ModNPC
    {
        ...
        public override float SpawnChance(NPCSpawnInfo spawnInfo)
        {
            ...
            if (clamMod != null)
            {
                if (spawnInfo.player.GetModPlayer<CalamityPlayer>().ZoneSulphur && !CalValEXConfig.Instance.CritterSpawns)
                {
        ...
        {
            Texture2D texture = ModContent.GetTexture("CalValEX/NPCs/Critters/NukeFly_Glow");

...
{
    internal class OldAstralDoorItem : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Xenomonolith Door");
        }
        ...
        public override void SetDefaults()
        {
            ...
            item.createTile = ModContent.TileType<OldAstralDoorClosed>();
            item.width = 12;
            item.height = 12;
            item.rare = 0;
        }
        ...
        public override void AddRecipes()
        {
            Mod CalValEX = ModLoader.GetMod("CalamityMod");
            {
                ...
                recipe2.AddIngredient(ModLoader.GetMod("CalamityMod").ItemType("MonolithDoor"));

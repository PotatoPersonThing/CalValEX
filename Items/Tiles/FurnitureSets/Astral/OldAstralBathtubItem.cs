...
namespace CalValEX.Items.Tiles.FurnitureSets.Astral
{
    public class OldAstralBathtubItem : ModItem
    {
        ...
        {
            // DisplayName.SetDefault("Xenomonolith Bathtub");
        ...
        public override void SetDefaults()
        {
            ...
            Item.createTile = ModContent.TileType<OldAstralBathtub>();
            Item.width = 12;
            Item.height = 12;
            Item.rare = 0;
        }
        ...
        /*public override void AddRecipes()
        {
            Mod CalValEX = ModLoader.GetMod("CalamityMod");
            {
                ...
                recipe2.AddIngredient(ModLoader.GetMod("CalamityMod").ItemType("MonolithBathtub"));

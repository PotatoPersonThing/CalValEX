...
{
    public class CalamitasLog : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.createTile = ModContent.TileType<CalamitasBlueprintPlaced>();
            Item.width = 46;
            Item.height = 32;
            Item.rare = 6;
        }
        ...
        /*public override void AddRecipes()
        {
            Mod CalValEX = ModLoader.GetMod("CalamityMod");
            {
                ...
                recipe.AddIngredient(ModLoader.GetMod("CalamityMod").ItemType("CalamityDust"), 1);

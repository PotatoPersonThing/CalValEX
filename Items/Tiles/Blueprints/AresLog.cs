...
{
    public class AresLog : ModItem
    {
        //public override string Texture => "CalValEX/Items/Tiles/Blueprints/Blueprint";
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("XF-09 Ares Project Blueprint");
            Tooltip.SetDefault("The got damn uh");
        }
        ...
        public override void SetDefaults()
        {
            ...
            item.createTile = ModContent.TileType<AresBlueprintPlaced>();
            item.width = 46;
            item.height = 32;
            item.rare = 7;
        }

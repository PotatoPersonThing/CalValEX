...
{
    public class StormWeaverPlush : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.noMelee = true;
            Item.value = 20;
            Item.createTile = ModContent.TileType<StormWeaverPlushPlaced>();
            Item.maxStack = 99;
        }
        ...
        /*public override void AddRecipes()
        {
            Mod CalValEX = ModLoader.GetMod("CalamityMod");
            {
                ...
                recipe.AddIngredient(ModContent.ItemType<StormWeaverPlushThrowable>());

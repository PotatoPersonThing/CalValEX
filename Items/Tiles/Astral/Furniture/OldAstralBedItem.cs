...
{
    internal class OldAstralBedItem : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Xenomonolith Bed");
        }
        ...
        public override void SetDefaults()
        {
            ...
            item.createTile = ModContent.TileType<OldAstralBed>();
            item.width = 12;
            item.height = 12;
            item.rare = 0;
        }
        ...
        public override void AddRecipes()
        {
            Mod CalValEX = ModLoader.GetMod("CalamityMod");
            {
                ...
                recipe2.AddIngredient(ModLoader.GetMod("CalamityMod").ItemType("MonolithBed"));

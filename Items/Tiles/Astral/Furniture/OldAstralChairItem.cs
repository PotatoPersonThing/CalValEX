...
{
    internal class OldAstralChairItem : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Xenomonolith Chair");
        }
        ...
        public override void SetDefaults()
        {
            ...
            item.createTile = ModContent.TileType<OldAstralChair>();
            item.width = 12;
            item.height = 12;
            item.rare = 0;
        }
        ...
        public override void AddRecipes()
        {
            Mod CalValEX = ModLoader.GetMod("CalamityMod");
            {
                ...
                recipe2.AddIngredient(ModLoader.GetMod("CalamityMod").ItemType("MonolithChair"));

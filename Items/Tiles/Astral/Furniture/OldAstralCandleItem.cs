...
{
    internal class OldAstralCandleItem : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            item.createTile = ModContent.TileType<OldAstralCandle>();
            item.width = 12;
            item.height = 12;
            item.rare = 0;
        }
        ...
        public override void AddRecipes()
        {
            Mod CalValEX = ModLoader.GetMod("CalamityMod");
            {
                ...
                recipe2.AddIngredient(ModLoader.GetMod("CalamityMod").ItemType("MonolithCandle"));

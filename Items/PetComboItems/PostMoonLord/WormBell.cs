...
namespace CalValEX.Items.PetComboItems.PostMoonLord
{
    public class WormBell : ModItem
    {
        ...
        {
            CreateRecipe()
                .AddIngredient(ModContent.ItemType<WeaverFlesh>())
                .AddIngredient(ModContent.ItemType<SeaCoin>())
                .AddIngredient(ModContent.ItemType<AstralStar>())
                .AddIngredient(ModContent.ItemType<DogPetItem>())

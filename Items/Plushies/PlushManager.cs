...
namespace CalValEX.Items.Plushies
{
    public class PlushManager : ModSystem
    {
        ...
        public override void Load()
        {
            ...
            LoadPlush("NamelessDeity", 16, sound: GetOtherModSound("NoxusBoss", "NoxusBoss/Assets/Sounds/Custom/NamelessDeity/ScreamShort", SoundID.Item163));
            LoadPlush("NamelessDeityEX", 16, false, 3, 3, sound: GetOtherModSound("NoxusBoss", "NoxusBoss/Assets/Sounds/Custom/NamelessDeity/Appear", SoundID.Item164));
        }

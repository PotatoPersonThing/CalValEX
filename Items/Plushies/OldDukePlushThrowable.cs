...
namespace CalValEX.Items.Plushies
{
    public class OldDukePlushThrowable : ModItem
    {
        ...
        {
            DisplayName.SetDefault("Old Duke Plushie (Throwable)");
        ...
        public override void SetDefaults()
        {
            ...
            Item.noMelee = true;
            Item.value = 20;
            Item.shoot = ModContent.ProjectileType<OldDukePlush>();
            Item.shootSpeed = 6f;
            Item.maxStack = 99;
        }
        ...
        /*public override void AddRecipes()
        {
            
            {
                ...
                recipe.AddIngredient(ModContent.ItemType<Items.Tiles.Plushies.OldDukePlush>());
